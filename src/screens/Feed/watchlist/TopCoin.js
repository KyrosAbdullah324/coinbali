...
import { View, StyleSheet,Dimensions,TouchableWithoutFeedback, Text, FlatList, Image, Modal, TouchableOpacity } from "react-native";
        ...
        <View style={styles.container}>
            ...
            <View style={{ flex: 1, width: '100%' }}>
                ...
                <View style={styles.title} >
                    <SettingTitle title="Top Coin" goWithNavigate={() => navigation.goBack()} backnavigate={true} />
                    <Icon style={styles.iconstyle} name="dots-horizontal" size={24} color="black" onPress={(e) => { ActionRef.current(e) }} />
                </View>
