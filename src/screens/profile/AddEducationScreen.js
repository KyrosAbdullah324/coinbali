...
export default () => {
  ...
  return (
      <View style={styles.container}>
        <SettingTitle title={editFlag ? "Edit Education" : "Add Education"} goWithNavigate={()=>navigation.goBack()} backnavigate={true} />
        <View style={styles.formContainer}>
          ...
          <View style={styles.deleteContainer}>
            {
              ...
              >
                ...
                <Text style={styles.deleteEducationText}>Delete Education</Text>
              </TouchableOpacity>
            }
          </View>
          <View style={styles.btnGroup}>
            <TouchableOpacity
              ...
              onPress={() => navigation.goBack()}
            >
              <Text style={styles.loginButtonText}>{editFlag ? "Save changes" : "Add Education"}</Text>
            </TouchableOpacity>
            <TouchableOpacity
